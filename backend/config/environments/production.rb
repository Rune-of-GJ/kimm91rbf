...
Rails.application.configure do
  ...
  # This app is currently served directly from the container on EC2.
  # Do not force Rails to treat every request as SSL unless a real reverse proxy is configured.
