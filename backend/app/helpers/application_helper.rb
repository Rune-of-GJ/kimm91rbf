    ...
    content_tag(:nav, class: "page-nav") do
      safe_join([
        content_tag(:div, safe_join([
          ...
          design_nav_link("강의 시청", lecture_player_path, :lecture_player, active_page),
          design_nav_link("내 강의", my_courses_path, :my_courses, active_page),
          design_nav_link("진도", progress_path, :progress, active_page)
        ]), class: "page-nav-links"),
        content_tag(:div, safe_join([
          design_nav_link("회원가입", signup_path, :signup, active_page),
          design_nav_link("로그인", login_path, :login, active_page)
        ]), class: "page-nav-actions")
      ])
    end
  end
end
