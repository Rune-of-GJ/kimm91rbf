class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    ...
    add_index :solid_queue_jobs, [:queue_name, :finished_at, :scheduled_at, :id], name: :index_solid_queue_jobs_for_filtering
    add_index :solid_queue_jobs, [:scheduled_at, :finished_at, :priority], name: :index_solid_queue_jobs_for_alerting
    ...
    add_index :solid_queue_scheduled_executions, [:scheduled_at, :priority, :job_id], name: :index_solid_queue_dispatch_order
    ...
    add_index :solid_queue_claimed_executions, :process_id
